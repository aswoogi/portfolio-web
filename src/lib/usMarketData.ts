...
export const US_PAIRS: Pair[] = [
  ...
  { symbol: "^DJI", name: "다우존스", desc: "미국 우량주 30개", future: "YM=F", tier: "T0", sector: "dashboard", direction: "direct" },
  { symbol: "^IXIC", name: "나스닥", desc: "미국 기술주 전체", future: "NQ=F", tier: "T0", sector: "dashboard", direction: "direct" },
  { symbol: "^KS11", name: "KOSPI", desc: "한국 대형주 지수", tier: "T0", sector: "dashboard", direction: "direct" },
  { symbol: "^KQ11", name: "KOSDAQ", desc: "한국 중소형주 지수", tier: "T0", sector: "dashboard", direction: "direct" },
  ...
  // ⚡ 에너지
  { symbol: "CL=F", name: "WTI 원유", desc: "국제 유가 — 정유·에너지 직결", tier: "T1", sector: "에너지", direction: "direct" },
  { symbol: "NG=F", name: "천연가스", desc: "헨리허브 — LNG·발전·난방", tier: "T1", sector: "에너지", direction: "direct" },
  ...
  { symbol: "XME", name: "XME", desc: "S&P 금속·광산 ETF", tier: "T2", sector: "원자재", direction: "direct" },
  { symbol: "GLD", name: "GLD", desc: "금 ETF", tier: "T2", sector: "원자재", direction: "direct" },
  { symbol: "SLV", name: "SLV", desc: "은 ETF", tier: "T2", sector: "원자재", direction: "direct" },
  { symbol: "COPX", name: "COPX", desc: "구리 채굴 ETF", tier: "T2", sector: "원자재", direction: "direct" },
  { symbol: "URA", name: "URA", desc: "우라늄 ETF", tier: "T2", sector: "원자재", direction: "direct" },
...
export const SECTOR_ORDER: string[] = [
  ...
  "자동차", "건설", "금융", "플랫폼", "바이오", "로봇", "원자재", "한국지수",  // T2
];
